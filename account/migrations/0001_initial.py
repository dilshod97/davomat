    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lavozim', models.CharField(blank=True, max_length=150, null=True)),
                ('profiles', models.TextField(null=True)),
                ...
                ('sector', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_sector', to='account.sector')),
            ],
            options={
                'verbose_name': 'user',
